...
class PetFriends:
    ...
    # Своя реализация POST - create_pet_simple
    ...
    # Своя реализация POST - set_photo

    def add_photo_by_pet_id(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод загружает на сервер фото для ранее добавленного питомца и возвращает статус
        запроса на сервер и результат в формате JSON с данными обновлённого питомца"""
